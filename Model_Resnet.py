...
def Model_RESNET(train_data, train_target, test_data, test_target, BS, Act=None, sol=None):
    if sol is None:
        sol = [1]
    if Act is None:
        Act = 1
    ...
    base_model.summary()
    base_model.fit(train_data, train_target, epochs=5, batch_size=BS, validation_data=(test_data, test_target))
